function [imMat] = createTrainSet(filePath, offset)%offest=1
    ...
    for a=1:fileSize
        ...
        IC = imread(strcat('data/FingerVeinDatabase/sharpenedvein_feature2/',fileList{a}));
%         IC = mat2gray(IC);% intensity normalization
        [m,n] = size(IC);
